               ...
               return(
                <div key={i}>
                    ...
                    <div className="preview__answers">
                      {element.answerOptions.map((el, index)=>{
                        return(
                          <PreviewAnswer key={index} text={el.answerText} stateClass={setPreviewState(element.correctAnswers,element.selectedAnswers,el)}/>
                      )
                      })}
                    </div>
                </div>
